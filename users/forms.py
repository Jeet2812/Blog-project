...
class RegisterForm(UserCreationForm):
    ...
    widget=forms.PasswordInput(attrs={'placeholder':'password1','class':'form-control','data-toggle':'password','id':'password'}))

    password2: forms.CharField(max_length=100, required=True,
    widget=forms.PasswordInput(attrs={'placeholder':'password2','class':'form-control','data-toggle':'password','id':'password'}))
